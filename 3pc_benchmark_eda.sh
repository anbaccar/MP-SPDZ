...
for ring in "${ring_sizes[@]}"; do
    for batch in "${batch_sizes[@]}"; do
        ...
        (echo "($ring, $batch, $num_iterations)") | tee -a $ring_MP-SPDZ_eda_$1_$2_$timestamp.txt
        ...
        for iter in $(seq 1 $num_iterations); do
            ...
            ./replicated-ring-party.x -ip HOSTS $1 eda-bench-$ring-$batch 2>&1 | (grep 'Data sent\|Time') | tee -a $ring_MP-SPDZ_eda_$1_$2_$timestamp.txt
        done
    done
done
